...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D977700EC45975")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class AmazonSearch : OpenSpan.Automation.Automator
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D977700EC45975\\EntryPoint-8D9777CA1AA6695")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D977700EC45975\\HiddenTypeProxy-8D9777CA3908038")]
	...
	public AmazonSearch()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(AmazonSearch));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D977700EC45975");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D9777CA1AA6695"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8D9777CA3908038"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777CB29B84E3"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777CC9235920"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D9777CDCE849F4"));
		this.SetId(this.connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777CE522180A"));
		this.SetId(this.connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777D7002AAA6"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D9777D75C7456D"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D9777D81628DFF"));
		// 
		// AmazonSearch
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_AmazonSearch_1_");
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_AmazonSearch_2_");
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AmazonSearch_3_");
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_AmazonSearch_4_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_AmazonSearch_5_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_AmazonSearch_6_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D977700EC45975\\EntryPoint-8D9777CA1AA6695");
		...
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A");
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_AmazonSearch_7_");
		...
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\TextBox-8D976D2550F030B");
		...
		this.connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\TextBox-8D976D2550F030B");
		...
		this.connectableMethod3.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.Button";
		this.connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\Button-8D976D28BA8642A");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_AmazonSearch_7_");
		this.connectableMethod4.DynamicMembers.Add(dynamicpropertyinfo6);
		this.connectableMethod4.ExceptionsHandled = false;
		this.connectableMethod4.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\WebControl-8D976E0ED075936");
		...
		this.connectableProperties2.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\WebControl-8D976E0ED075936");
		memberprototype6.DefaultValue = null;
		memberprototype6.MemberName = "InnerText";
		...
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_AmazonSearch_8_");
		...
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_AmazonSearch_9_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D977700EC45975\\EntryPoint-8D9777CA1AA6695");
		// 
		// Initialize CodeDom data
		// 
		this.CodeDomData = _resources_.GetString("_AmazonSearch_10_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D9777CA1AA6695"));
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8D9777CA3908038"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777CB29B84E3"));
		...
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Start";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777CC9235920"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AmazonSearch_7_");
		...
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\TextBox-8D976D2550F030B");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D9777CDCE849F4"));
		connectableProperties1.DefaultValues = "";
		connectableProperties1.DisplayName = "Properties";
		connectableProperties1.ExceptionsHandled = false;
		connectableProperties1.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.TextBox";
		connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\TextBox-8D976D2550F030B");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777CE522180A"));
		connectableMethod3.DisplayName = "<PerformClick>";
		connectableMethod3.ExceptionsHandled = false;
		connectableMethod3.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.Button";
		connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\Button-8D976D28BA8642A");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D9777D7002AAA6"));
		...
		connectableMethod4.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\WebControl-8D976E0ED075936");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "WaitForCreate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D9777D75C7456D"));
		connectableProperties2.DefaultValues = "";
		connectableProperties2.DisplayName = "Properties";
		connectableProperties2.ExceptionsHandled = false;
		connectableProperties2.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D976D2218B4C8A\\WebControl-8D976E0ED075936");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "InnerText";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
		memberprototype1.Signature.ReturnType = null;
		memberprototype1.TypeName = "System.String";
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D9777D81628DFF"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AmazonSearch_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_AmazonSearch_9_");
		...
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_AmazonSearch_3_");
		...
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_AmazonSearch_4_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo5 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo5.IsSerializable = true;
		dynamicpropertyinfo5.NoInputConvesion = false;
		dynamicpropertyinfo5.Source = "";
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_AmazonSearch_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo6 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo6.IsSerializable = true;
		dynamicpropertyinfo6.NoInputConvesion = false;
		dynamicpropertyinfo6.Source = "";
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_AmazonSearch_6_");
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo4);
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D977700EC45975\\EntryPoint-8D9777CA1AA6695");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D9777CA1AA6695"));
